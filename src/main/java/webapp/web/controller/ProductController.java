...
import webapp.web.model.Product;
...
public class ProductController {
    ...
    @Autowired
    private webapp.web.service.ProductService productService;

    @Autowired
    private webapp.web.service.ProductTypeService productTypeService;
